...
<div class="body-content row">
	<div class="col-md-2 text-left">
		...
		<a id="click" href="#">Find cats by name</a>
		<div id="filter-list" style="max-height: 500px;overflow-y:scroll">

			<div class="item-list">
			@foreach($cat as $value)			
					<a class="item-red" href="{{ URL::to('/cats/profile/'.$value->id) }}"><div class="items">{{ $value->name }}</div></a>			
			@endforeach	
	...
	@if(count($cat))
		...
		<div class="img-box" style="float:left">
			<a href="{{ URL::to('/cats/profile/'.$value->id) }}" >
