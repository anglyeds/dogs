        ...
        <div class="col-md-5 col-sm-6">
            <div class="row">
                <div id="links" class="links">
                    ...
                    @php
                        if($other->multiple_images) {
                            $images = json_decode($other->multiple_images);
                        }else {
                            $images = [];
                        }
                    @endphp
        ...
        <div class="col-md-7 col-sm-6">
            <div class="row">
                <div class="animal-content">
                    <h4>Name 名字 :<span> {{$other->name}} </span></h4>
                    <small>
                    ...
                    <p>Description 描述 :<span>{{ $other->description }}</span></p>
                    <p>Type 種類 : {{ $other->type }}</p>
                    <p>Breed 品種 : {{ $other->breed }}</p>
                    <p>Size 體型 : {{ $other->size }}</p>
                    <p>Age 年齡 : {{ $other->age }}</p>
                    <p>Coat Colour : 毛色{{ $other->coat_colour }}</p>
                    <p>Skills 技能 : {{ $other->skills }}</p>
                    <p>Shooting Experience 拍攝經驗 : {{ $other->shooting_exp }}</p>
                </div>
                <!-- Split button -->
                <div class="btn-group" >
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="video-container">
                                    ...
                                    @if(preg_match('/embed/', $other->video_link))
                                        <iframe width="640" height="360" src="{{ $other->video_link }}" frameborder="0" allowfullscreen></iframe>
                                    @else
